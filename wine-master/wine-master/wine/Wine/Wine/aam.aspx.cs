...
namespace Wine
{
    public partial class aam : System.Web.UI.Page
    {
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            {
                Response.Write("<script>alert('ფირმა მსგავსი ID - ით უკვე არსებობს. სცადე სხვა!');</script>");
            }
            else
            {
                addNewAuthor();
        ...
        protected void Button3_Click(object sender, EventArgs e)
        {
            ...
            {
                Response.Write("<script>alert('ფირმა არ არსებობს');</script>");
            }
        }
        // delete button click
