    ...
    public partial class signup1 : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            if (checkMemberExists())
            {
                ...
                Response.Write("<script>alert('მომხმარებელი მსგავსი ID - ით უკვე რეგისტრირებულია, სცადეთ სხვა!');</script>");
            }
            else
            {
                signUpNewMember();
        ...
        void signUpNewMember()
        {
            ...
            try
            {
                ...
                cmd.ExecuteNonQuery();
                con.Close();
                Response.Write("<script>alert('რეგისტრაცია წარმატებით დასრულდა!');</script>");
            }
            catch (Exception ex)
            {
                Response.Write("<script>alert('" + ex.Message + "');</script>");
