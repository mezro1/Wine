<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="signup1.aspx.cs" Inherits="Wine.signup1" %>
         ...
         <div class="col-md-8 mx-auto">
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="row">
                     <div class="col-md-6">
                        ...
                        <div class="form-group">
                           <asp:TextBox Class="form-control" ID="TextBox1" runat="server" placeholder="მაგ : ნიკა მეზვრიშვილი"></asp:TextBox>
                        </div>
                     </div>
                     <div class="col-md-6">
                        <label>დაბადების თარიღი</label>
                        <div class="form-group">
                           <asp:TextBox Class="form-control" ID="TextBox2" runat="server" placeholder="მაგ : 12/12/1998" TextMode="Date"></asp:TextBox>
                        </div>
                     </div>
                  </div>
                  <div class="row">
                     <div class="col-md-6">
                        ...
                        <div class="form-group">
                           <asp:TextBox Class="form-control" ID="TextBox3" runat="server" placeholder="მაგ : 555 555 555" TextMode="Number"></asp:TextBox>
                        </div>
                     </div>
                     <div class="col-md-6">
                        <label>ელ. ფოსტა</label>
                        <div class="form-group">
                           <asp:TextBox Class="form-control" ID="TextBox4" runat="server" placeholder="მაგ : someone@example.com" TextMode="Email"></asp:TextBox>
                        </div>
                     </div>
                  </div>
                  <div class="row">
                     ...
                     <div class="col-md-4">
                        <label>ქალაქი</label>
                        <div class="form-group">
                            <asp:TextBox class="form-control" ID="TextBox6" runat="server" placeholder="მაგ : თბილისი" ></asp:TextBox>
                        </div>
                     </div>
                     <div class="col-md-4">
                        <label>საფოსტო ინდექსი</label>
                        <div class="form-group">
                           <asp:TextBox class="form-control" ID="TextBox7" runat="server" placeholder="მაგ : 30003" TextMode="Number"></asp:TextBox>
                        </div>
                     </div>
                  </div>
                  <div class="row">
                     <div class="col">
                        ...
                        <div class="form-group">
                           <asp:TextBox Class="form-control" ID="TextBox5" runat="server" placeholder="მაგ : თბილისი , გლდანი 8 მკ/რნ , 7 კ, ბ 25."  Rows="2"></asp:TextBox>
                        </div>
                     </div>
                  </div>
                  <div class="row">
                  ...
                  <div class="row">
                     <div class="col-md-6">
                        <label>მომხმარებლის ID ლათინურად</label>
                        <div class="form-group">
                           <asp:TextBox class="form-control" ID="TextBox8" runat="server" placeholder="მაგ : Bogma777"></asp:TextBox>
                        </div>
                     </div>
                     <div class="col-md-6">
                        <label>პაროლი</label>
                        <div class="form-group">
                           <asp:TextBox class="form-control" ID="TextBox9" runat="server" placeholder="********" TextMode="password"></asp:TextBox>
                        </div>
                     </div>
                  </div>
                  <div class="row">
                     <div class="col">
                        <div class="form-group">
                          <asp:Button class="btn btn-success btn-block btn-lg" ID="Button1" runat="server" Text="რეგისტრაცია" OnClick="Button1_Click" />
                        </div>
                     </div>
                  </div>
               </div>
            </div>
            <a href="homepage.aspx"><< უკან სახლისკენ</a><br><br>
         </div>
      </div>
   </div>
</asp:Content>
